...
public class LeituraDAO {
        ...
        public void enviarLeitura(Integer fkEquipamento) {
            ...
            String sql = "insert into [dbo].[Leitura](dataHora,RAM,fkEquipamento,cpuFrequencia,tempoAtividade) values (getDate(),?,?,?,?)";

            conn.update(sql, ramUso, fkEquipamento, cpuFrequencia, tempAtividade);
